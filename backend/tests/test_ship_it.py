...
def test_the_recap_note_carries_the_closers_origin(fresh_db, origin):
...
def test_ship_it_counts_only_linked_blockers(client, fresh_db):
...
def test_ship_it_recap_omits_zero_stats(fresh_db):
    from app.services import engagements
...
def test_ship_it_recap_omits_zero_day_duration(fresh_db):
    from app.services import engagements
...
def test_ship_it_recap_single_stat_no_orphan_separators(client, fresh_db):
