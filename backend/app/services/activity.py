...
VERBS: dict[str, tuple[str, str]] = {
    ...
    "add_mcp_server": ("added a personal MCP server", "loud"),
    "delete_mcp_server": ("deleted a personal MCP server", "loud"),
    "delete_mcp_servers_for": ("deleted a person's MCP servers", "loud"),
