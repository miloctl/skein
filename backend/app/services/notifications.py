...
- immediate and digest: in-app rows, available as soon as they are created
- passive: activity log only (no notification row)
"""
...
def _insert_notification(
    ...
    nid = db.execute(
        ...
        ' ("user", tier, message, link, created_at, source_entity, source_id,'
