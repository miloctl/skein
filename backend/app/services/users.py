...
_ATTRIBUTION: dict[str, tuple[str, ...]] = {
    ...
    "forge_receipts": ("created_by",),
    "github_recovery_api": ("created_by",),
    "github_recovery_hooks": ("created_by", "reconciled_by"),
    "github_recovery_deliveries": ("created_by",),
    "github_recovery_attempts": ("created_by",),
