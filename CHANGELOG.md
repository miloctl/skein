...
- Task Peek restores focus only after a panel has opened. Initial page load keeps the normal keyboard order and skip link. Closing a panel still returns focus to its opener or Search when the opener is gone.
