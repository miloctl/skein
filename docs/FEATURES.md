...
| Full-text search | FTS5 over every entity; optional embeddings (`SKEIN_EMBEDDINGS=1`; provider via `SKEIN_EMBED_PROVIDER` — openai, openai_compatible, or keyless ollama) | `GET /api/search?q=` · CLI `skein search` |
