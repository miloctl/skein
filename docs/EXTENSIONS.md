...
This revision declares package line `0.6.3`. Registry pull-back and annotated tag `v0.6.3` are the authority for completed publication.
...
```sh
pip install skein-agents==0.6.3 \
...
It removes both old distributions. Then it installs `skein-agents` 0.6.3 and
