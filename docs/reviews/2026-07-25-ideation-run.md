...
noticed. Status: **fixes applied**. Since then (2026-07-27): **P5
...
CoS fixes (1-4): **applied** (answer/resolve/disposition/close
notification loops).
...
(capture rate limit) **applied**. NOT applied (design): #1 chat
...
emoji) **applied**. Not applied: 4 (wave hydration — verified
