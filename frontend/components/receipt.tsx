 ...
 *  2026-08-01". The sentence was the whole output, so a reader who wanted the
 *  milestone went hunting for it by id on a page of them. The words are
 *  unchanged and stay first; the reference becomes a link in place.
 *
 *  Runs, never `dangerouslySetInnerHTML`: a receipt quotes titles people wrote
 *  (components/artifact-markdown.tsx and the search snippet follow the same
